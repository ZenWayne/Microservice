...
var (
	...
	// ValueScanner of all Transaction fields.
	ValueScanner struct {
		TxHash  field.TypeValueScanner[common.Hash]
		From    field.TypeValueScanner[common.Address]
		To      field.TypeValueScanner[common.Address]
