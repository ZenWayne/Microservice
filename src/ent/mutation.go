...
func (m *TransactionMutation) SetTokenId(u uint64) {
	m.tokenId = &u
	m.addtokenId = nil
}

// TokenId returns the value of the "tokenId" field in the mutation.
func (m *TransactionMutation) TokenId() (r uint64, exists bool) {
	v := m.tokenId
	if v == nil {
		return
	}
...
// If the Transaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TransactionMutation) OldTokenId(ctx context.Context) (v uint64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TransactionMutation) AddTokenId(u int64) {
	if m.addtokenId != nil {
		*m.addtokenId += u
	} else {
		m.addtokenId = &u
...
func (m *TransactionMutation) AddedTokenId() (r int64, exists bool) {
	v := m.addtokenId
	if v == nil {
		return
	}
